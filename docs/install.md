...
To download the latest stable release, [see here](https://github.com/sammy-ette/Hilbish/releases/latest)
...
Hilbish is currently in the testing/edge repository for Alpine.
...
To see steps on compiling Hilbish from source, [visit the GitHub repository](https://github.com/sammy-ette/Hilbish#build)
